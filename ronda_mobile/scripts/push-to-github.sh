...
echo -e "${GREEN}✓ تم الرفع على GitHub!${NC}"
echo ""
echo -e "${BOLD}الخطوات التالية:${NC}"
echo -e "  1. افتح: ${CYAN}https://github.com/${GH_USER}/${GH_REPO}/actions${NC}"
echo -e "  2. ستجد workflow يبني APK تلقائياً"
echo -e "  3. بعد ~10 دقائق، حمّل الـ APK من Artifacts"
echo ""
echo -e "${YELLOW}ملاحظة: أنشئ الـ Repository أولاً على github.com قبل تشغيل هذا السكريبت${NC}"
